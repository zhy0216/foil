...
| --- | --- | --- | --- | --- | --- |
| [01-typography-scope-lists.md](01-typography-scope-lists.md) | P0 | medium | opencode，继承默认 | opencode-go/deepseek-flash | 修正正文设置、行盒和列表显示，建立文档样式作用域 |
| [02-cjk-fonts-paper.md](02-cjk-fonts-paper.md) | P1 | medium | opencode，继承默认 | opencode-go/deepseek-flash | 中文字体回退、统一标题字体与 Paper 外观 |
...
1. [01-typography-scope-lists.md](01-typography-scope-lists.md) — 依赖：无。
2. [02-cjk-fonts-paper.md](02-cjk-fonts-paper.md) — 依赖 `01-typography-scope-lists.md`。
