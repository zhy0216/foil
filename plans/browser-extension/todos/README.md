...
Status: 01 is merged and cleaned at `86d6aaa18b2525a7ab0f147d4ddb1a6fe30ee460`; 02 is merged and cleaned at `ed3294d4305d89582be9133bc09c4b1434706586`; 03 is integrated and cleaned at `7b195b6c99688c744b5cce21b40e412b3ec92cb1`; 04 is merged and cleaned at `6573c179c2da6a3039517629ae521d48a40f3688`. All four tasks are complete; see the plan’s final execution record. Product: a Chrome/Edge MV3 toolbar button opens the full editor in a new tab. Honor any later user correction before starting dependent work.
...
| [04-extension-regressions.md](done/04-extension-regressions.md) | Merged and cleaned (`6573c17`) | P1 | hard | codex, inherited default | gpt-6-astra / max | Exercise the installed package, cross-host sharing and files; wire CI and document build/install/privacy behavior |
...
4. [04-extension-regressions.md](done/04-extension-regressions.md)
   ...
   Merged and cleaned at `6573c17`; see its archived 876-unit/55-browser acceptance evidence, alternate-base and configured-share results, checked ZIP/report paths, diagnosed failures and coordinator notice for the minimal shared password-cancellation fix. Coordinator independently passed frozen install, typecheck, all 876 units, both builds, all 55 browser cases, audits and package validation before fast-forward integration. Depends on integrated `03-share-link-import.md` (and 01/02 transitively). Owns installed-extension Playwright tests, final package assertions, CI integration/artifacts, root/extension documentation, and final cross-host/file regressions.
